...
| `template`           | `template`            | The name of the template that will be loaded. The generated path will have the format <code>${basePath}/templates/${template}.html</code>.                                                                                | `string`  | `undefined` |
