...
@Component({
  tag: "wcc-app-error-toast",
  styleUrls: {
    default: "../../../styles/wcc-app-error-toast/wcc-app-error-toast.scss",
  },
})
export class WccAppErrorToast {
  @HostElement() host: HTMLElement;

  @Listen("wccAppWarning", { target: "window" })
  ...
  @Listen("wccAppError", { target: "window" })
