...
| `closeButtonText`    | `close-button-text`    | The text that will appear on the footer close button (if neither the "footer" slot nor modalFooterContent are provided)   | `string`  | `"Close"`   |
...
- [wcc-spinner](../wcc-spinner)

### Graph
```mermaid
graph TD;
  wcc-modal --> wcc-spinner
  style wcc-modal fill:#f9f,stroke:#333,stroke-width:4px
```
